  ...
  <div class="min-h-screen flex flex-col">
      ...
      <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
          ...
          <nav class="hidden sm:flex space-x-8 text-sm font-medium">
            <a
              href="index.php"
              class="text-gray-600 hover:text-gray-900 transition">Bosh sahifa</a>
            <a
              href="loyhalar.php"
              class="text-gray-900 font-semibold border-b-2 border-gray-900 pb-1">Loyihalar</a>
          </nav>
          <!-- Mobile menu toggle -->
        ...
        <div id="mobileMenu" class="sm:hidden hidden pb-3 pt-1 space-y-2">
          <a href="index.php" class="block text-gray-600 py-2">Bosh sahifa</a>
          <a
            href="loyhalar.php"
            class="block text-gray-900 font-semibold py-2">Loyihalar</a>
        </div>
      </div>
    </header>
    ...
    <footer class="bg-white border-t border-gray-200 mt-auto">
      <div
        ...
        <div>
          <i class="far fa-copyright"></i> 2025 IqbolshohDev. Barcha huquqlar
          himoyalangan.
        </div>
        <div class="flex space-x-5 mt-3 sm:mt-0">
          <a href="#" class="hover:text-gray-800 transition"><i class="fab fa-github text-lg"></i></a>
          <a href="#" class="hover:text-gray-800 transition"><i class="fab fa-telegram text-lg"></i></a>
          <a href="#" class="hover:text-gray-800 transition"><i class="fab fa-linkedin-in text-lg"></i></a>
        </div>
      </div>
    </footer>
  </div>
